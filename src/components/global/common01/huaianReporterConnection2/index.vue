  ...
  <div class="huaian-common01-workmap" id="huaian-common01-workmap">
    <div class="reporter-map-wrap sys-flex sys-flex-center flex-justify-center">
      ...
      <div class="reporter-list-wrap">
        <div class="reporter-title common01-ft70">{{viewAttr.header || '记者列表'}}<div class="arrow" @click="changeShow()" :class="{arrowdown: !isShow}"></div></div>
        <div v-show="isShow">
...
export default {
  name: 'huaianReporterConnection2',
  props: {
    viewId: String
  },
  data () {
...
.huaian-common01-workmap {
  ...
  .reporter-map-wrap {
    ...
    .reporter-list-wrap {
      ...
      top: pxrem(40px);
      right: pxrem(46px);
      background: linear-gradient(#0035a0 0%, #04368a 100%);
      border: pxrem(4px) solid #0063ff;
      .reporter-title {
        width: 100%;
        height: pxrem(78px);
        line-height: pxrem(78px);
        background: linear-gradient(#006cc1 0%, #0048cb 100%);
        position:relative;
        .arrow{
          position: absolute;
          right:pxrem(26px);
          ...
          width: pxrem(28px);
          height: pxrem(18px);
          background: url("./assets/arrowTop.png") no-repeat center;
