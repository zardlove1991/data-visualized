<template>
  <div class="common01-clickrank">
    <div class="clickrank-wrap common01-border" v-if="!showDetail">
      <div class="common01-title" :style="setFontSize(63)">{{viewAttr.header || '稿件排行'}}</div>
...
export default {
  ...
  data () {
    return {
      ...
      count: 0,
      dataList: [
        {title: '绷紧思想之弦 落实防范之策 坚决夺取防汛抢险全面胜利'},
        {title: '芜湖这位少年凭什么感动亿万国人？！'},
        {title: '刚刚，2020年芜湖市区普高录取控制分数线公布'},
        {title: '呆萝卜”要在我市卷土重来？'},
        {title: '7月27日汛情通报：长江芜湖站水位缓落'},
        {title: '充满希望的田野 大有可为的热土'},
        {title: '【汛情通报】长江芜湖站水位缓落'},
        {title: '长江2020年第3号洪水形成'},
        {title: '【汛情通报】长江芜湖站水位缓落 较昨日回落0.09m'},
        {title: '芜湖一中换帅！新“掌门人”到任时说了什么？'}
      ],
      detailData: {},
      showDetail: false,
      customSize: false
