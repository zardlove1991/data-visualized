<template>
  <div class="common01-workmap">
    <!-- <div class="map-title">{{viewAttr.titletext || '电视总台全媒体采编指挥中心'}}</div> -->
    ...
    <div class="reporter-map-wrap sys-flex sys-flex-center flex-justify-center">
      ...
      <div class="reporter-list-wrap">
        <div class="reporter-title common01-ft70 flex flex-center" @click="isOpen = !isOpen">
          <div class="flex-one">{{viewAttr.header || '记者列表'}}</div>
          <i class="shouqi" :class="{'zhankai': isOpen}"></i>
        </div>
...
.common01-workmap {
  ...
  .reporter-map-wrap {
    ...
    .reporter-list-wrap {
      width: pxrem(505px);
      max-height: pxrem(600px);
      position: absolute;
      top: pxrem(200px);
      right: pxrem(32px);
      .reporter-title {
        padding: 0 pxrem(25px);
        width: 100%;
        height: pxrem(80px);
      ...
      .shouqi{
        ...
        width: pxrem(30px);
        height: pxrem(15px);
        border: solid pxrem(15px) transparent;
        border-top: none;
        border-bottom: solid pxrem(15px) #5B8CDC;
      }
      .zhankai{
        border: solid pxrem(15px) transparent;
        border-bottom: none;
        border-top: solid pxrem(15px) #5B8CDC;
      }
      .reporter-body {
        width: 100%;
        height: pxrem(600px);
