<template>
  <div class="common01-workmap">
    <div class="common01-sxtitle" id="common01-sxtitle">
    </div>
    ...
    .reporter-list-wrap {
      ...
      .reporter-body {
        ...
        .reporter-list {
          ...
          .member-name {
            width: 38%;
            margin: 0 pxrem(40px) 0 pxrem(14px);
            text-align: left;
            .name {
              margin-bottom: pxrem(13px);
            }
          }
          .connect {
            width: pxrem(55px);
            ...
            background-size: pxrem(55px) pxrem(36px);
            cursor: pointer;
            &.connect-audio {
          ...
          .list-body {
            padding: pxrem(18px) pxrem(30px) pxrem(21px);
          }
          .border-line{
            width: 100%;
            height: pxrem(3px);
