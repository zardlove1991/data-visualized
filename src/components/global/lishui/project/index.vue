...
.ls-project {
  ...
  .project-list{
    ...
    .project-user{
      width: 10%;
      text-align: left;
      line-height: pxrem(32px, 6.25);
      font-size: pxrem(32px, 6.25);
    ...
    .project-status{
      ...
      text-align: center;
      display: block;
      margin: 0 pxrem(64px, 6.25) 0 pxrem(32px, 6.25);
      text-align: center;
