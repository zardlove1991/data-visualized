<template>
  <div class="lishui-opinion">
    <div class="opinion-wrap" v-if="!showDetail">
      <div class="wrap-list sys-flex sys-flex-center flex-justify-between animated" :class="{'flipInX' : v.title}" :style="{'animation-delay' : k/2+'s'}" @click="showContentDetail(v)" v-for="(v, k) in dataList" :key="k">
