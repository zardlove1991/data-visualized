<template>
  <div class="container" id="qx-workcallInfoMap">
              ...
              <div class="reporter-list-content" v-if="reporterList && reporterList.length">
                <div class="reporter-list" v-for="(v,k) in reporterList" :key="k">
                    <div class="sys-flex sys-flex-center" @click="reporterLocate(v)">
                      ...
                      <div class="connect sys-flex sys-vertical flex-justify-between">
                        <div class="connect-audio" @click="callaudio(v)"></div>
                        <div class="connect-video" @click="callvideo(v)"></div>
                      </div>
                      <!-- @click="callvideo(v)" -->
                    </div>
...
export default {
  ...
  mounted () {
    this.setFontsize('qx-workcallInfoMap')
  ...
  methods: {
    rMap () {
      ...
      SquareOverlay.prototype.initialize = function (map) {
        ...
        img2.style.width = '0.5rem'
        img2.style.height = '0.5rem'
        img2.style.bottom = '0'
