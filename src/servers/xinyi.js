...
export const getWechatList = (count = 6, page = 1) => createAPI(`${httpsbaseUrl}/index.php?m=Apidaping&c=hotspot&a=website&custom_appid=${baseid}&custom_appkey=${basekey}&platform=workcall&custom_id=188&count=${count}&page=${page}&source=149434`) // 线索汇聚-微信
export const getWeiboList = (count = 6, page = 1) => createAPI(`${httpsbaseUrl}/index.php?m=Apidaping&c=hotspot&a=website&custom_appid=${baseid}&custom_appkey=${basekey}&platform=workcall&custom_id=188&count=${count}&page=${page}&source=149433`) // 线索汇聚-微博
...
export const getRankList = (count = 6) => createAPI(`${httpsbaseUrl}/index.php?m=Apidaping&c=m2odata&a=getRankList&custom_appid=${baseid}&custom_appkey=${basekey}&count=${count}`) // 稿件排行-阅读量
export const getRankCommentList = (count = 6) => createAPI(`${httpsbaseUrl}/index.php?m=Apidaping&c=m2odata&a=newsCommentRank&custom_appid=${baseid}&custom_appkey=${basekey}&count=${count}`) // 稿件排行-推荐量
