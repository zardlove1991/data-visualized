...
export const getWebsitList = (count = 6, page = 1) => createAPI(`${httpsbaseUrl}/index.php?m=Apidaping&c=hotspot&a=website&custom_appid=401&custom_appkey=bOvXb4GgRsHhgNh4OvdFGZmlHnqOIpPJ&platform=workcall&custom_id=188&count=${count}&page=${page}`) // 线索汇聚-网站
export const getWechatList = (count = 6, page = 1) => createAPI(`${httpsbaseUrl}/index.php?m=Apidaping&c=hotspot&a=wechat&custom_appid=401&custom_appkey=bOvXb4GgRsHhgNh4OvdFGZmlHnqOIpPJ&platform=workcall&custom_id=188&count=${count}&page=${page}`) // 线索汇聚-微信
export const getWeiboList = (count = 6, page = 1) => createAPI(`${httpsbaseUrl}/index.php?m=Apidaping&c=hotspot&a=weibo&custom_appid=401&custom_appkey=bOvXb4GgRsHhgNh4OvdFGZmlHnqOIpPJ&platform=workcall&custom_id=188&count=${count}&page=${page}`) // 线索汇聚-微博
